...
export default function ValidateDemoPage() {
  ...
  const headerPalette = {
    ...
    subtitle: 'Experiência demonstrativa do fluxo de validação.'
  }
  ...
  const documentName = 'declaracao-assinada.pdf'
  const documentId = 'demo-documento-123456'
  ...
  return (
    <div style={{ maxWidth: 900, margin: '24px auto', padding: 16 }}>
      ...
      <div style={{ marginBottom:12 }}>
        ...
        <div style={{ color:'#6b7280', fontSize:12 }}>ID: {documentId}</div>
      </div>
      ...
      <section style={{ border:`2px solid ${accentColor}`, borderRadius:12, padding:16, marginBottom:16 }}>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(200px, 1fr))', gap:12 }}>
          ...
          <div>
            ...
            <div style={{ fontFamily:'monospace', fontSize:13 }}>{documentId}</div>
          </div>
        </div>
        ...
        <div style={{ display:'grid', gap:16, gridTemplateColumns:'repeat(auto-fit, minmax(220px, 1fr))', alignItems:'start' }}>
          <div>
            ...
            {qr ? (
              <img
                src={qr}
                alt="QR Demo"
                style={{ border:'1px solid #e5e7eb', borderRadius:12, width:'100%', maxWidth:220, aspectRatio:'1 / 1', objectFit:'contain' }}
              />
            ) : (
          ...
          <div>
            ...
            <div style={{ fontSize:14 }}>
              O documento foi emitido em <strong>{createdAt}</strong> e permanece com status <strong>Assinado</strong>.
            </div>
